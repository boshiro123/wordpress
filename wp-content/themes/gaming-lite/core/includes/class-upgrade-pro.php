		...
		$manager->add_section(
			new Gaming_Lite_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.misbahwp.com/products/gaming-wordpress-theme',
					'pro_demo_text'    => esc_html__( 'View Demo', 'gaming-lite' ),
					'pro_demo_url'     => 'https://demo.misbahwp.com/gaming-pro/',
					'priority'    => 1,
				)
			)
		);
